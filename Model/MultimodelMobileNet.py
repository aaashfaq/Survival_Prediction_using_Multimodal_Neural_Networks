...
class CustomModel(nn.Module):
    ...
    def __init__(self, num_classes=1):
        ...
        # Add an embedding layer to extend features to size 512
    ...
    def forward(self, image, features):
        ...
        x = self.mobilenet_v2(image)

        # Flatten the features
        features = features.view(features.size(0), -1)

        # Apply the embedding layer to extend features to size 512
        extended_features = self.embedding(features)

        # Concatenate the MobileNetV2 output and extended features
...
if __name__ == '__main__':
    ...
    results={}
    curve_save_dir = "/root/code/thesis/codeFolder/LatestDataInUse/results/curves/Resnet/MRI4Sequences/Multimodal"
    ...
    for lr in learning_rates:
        ...
        survival_results_df.to_csv(f'/root/code/thesis/codeFolder/LatestDataInUse/results/survival/ResNet50/MRI4Sequences/Multimodal/survival_results_lr_{best_learning_rate}.csv', index=False)
        # Save classification report to file
        with open(f'/root/code/thesis/codeFolder/LatestDataInUse/results/reports/Resnet/MRI4Sequences/Multimodal/classification_report_lr_{best_learning_rate}.txt', 'w') as f:
    ...
    result_file = "/root/code/thesis/codeFolder/LatestDataInUse/results/MRI4Sequences_MultimodalMobileNet.txt"
