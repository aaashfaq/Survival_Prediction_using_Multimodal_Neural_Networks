...
class CustomModel(nn.Module):
    ...
    def forward(self, image, features):
        ...
        x = self.inception_v3(image)

        # Apply the embedding layer to extend features to size 64
        extended_features = self.embedding(features)

        extended_features = extended_features.view(extended_features.size(0), -1)

        # Concatenate the Inception v3 output and extended features
...
if __name__ == '__main__':
    ...
    model_save_dir = "/root/code/thesis/codeFolder/LatestDataInUse/results/models/Inceptionv3/"
    os.makedirs(model_save_dir, exist_ok=True)  # Ensure directory exists



    results={}
    curve_save_dir = "/root/code/thesis/codeFolder/LatestDataInUse/results/curves/Inceptionv3/"
    ...
    for lr in learning_rates:
        ...
        survival_dataframe.to_csv(f'/root/code/thesis/codeFolder/LatestDataInUse/results/survival/survival_df_lr_{best_learning_rate}.csv', index=False)

        # Save classification report to file
        with open(f'/root/code/thesis/codeFolder/LatestDataInUse/results/reports/Inceptionv3/classification_report_lr_{best_learning_rate}.txt', 'w') as f:
    ...
    result_file = "/root/code/thesis/codeFolder/LatestDataInUse/results/MultimodalInceptionv3.txt"
