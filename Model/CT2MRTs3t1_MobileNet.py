...
class CustomModel(nn.Module):
    ...
    def forward(self, image_CT, image_MRI):
        ...
        # Concatenate the MobileNetV2 outputs
...
if __name__ == '__main__':
    ...
    model_save_dir = "/root/code/thesis/codeFolder/LatestDataInUse/results/models/Resnet/CT2+s3t1_Resnet/Image"
    os.makedirs(model_save_dir, exist_ok=True)  # Ensure directory exists



    results={}
    curve_save_dir = "/root/code/thesis/codeFolder/LatestDataInUse/results/curves/Resnet/CT2+s3t1_Resnet/Image"
    ...
    for lr in learning_rates:
        ...
        for train_index, test_index in group_kfold.split(X, y, groups=dataset['PatientID']):
            ...
            # Calculate weights for each class based on the class distribution
            validation_class_counts = torch.tensor([validation_labels.count(label) for label in set(validation_labels)])
            validation_class_weights = 1.0 / validation_class_counts.float()
        ...
        survival_results_df.to_csv(f'/root/code/thesis/codeFolder/LatestDataInUse/results/survival/MobileNet/CT2+s3t1_Resnet/Image/survival_results_lr_{best_learning_rate}.csv', index=False)
        # Save classification report to file

        with open(f'/root/code/thesis/codeFolder/LatestDataInUse/results/reports/MobileNet/CT2+s3t1_Resnet/Image/classification_report_lr_{best_learning_rate}.txt', 'w') as f:
    ...
    result_file = "/root/code/thesis/codeFolder/LatestDataInUse/results/CT2+s3t1_ImageMobileNet.txt"
