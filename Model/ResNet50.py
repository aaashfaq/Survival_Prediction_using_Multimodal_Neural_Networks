...
if __name__ == '__main__':
    ...
    test_transform=transforms.Compose([
        transforms.ToTensor(),
        transforms.Resize((224,224)),
        transforms.Normalize([0.1634, 0.1634, 0.1634],[0.1898, 0.1898, 0.1898]),
       ])
       
    learning_rates = [0.01,0.001,0.0001]

    # Directory to save the best performing models
    model_save_dir = "/root/code/thesis/codeFolder/LatestDataInUse/results/models/Resnet/t2_hr_spir_range/Image"
    os.makedirs(model_save_dir, exist_ok=True)  # Ensure directory exists



    results={}
    curve_save_dir = "/root/code/thesis/codeFolder/LatestDataInUse/results/curves/Resnet/t2_hr_spir_range/Image"
    ...
    for lr in learning_rates:
        ...
        survival_results_df.to_csv(f'/root/code/thesis/codeFolder/LatestDataInUse/results/survival/ResNet50/t2_hr_spir_range/Image/survival_results_lr_{best_learning_rate}.csv', index=False)
        # Save classification report to file

        # Save classification report to file
        with open(f'/root/code/thesis/codeFolder/LatestDataInUse/results/reports/Resnet/t2_hr_spir_range/Image/classification_report_lr_{best_learning_rate}.txt', 'w') as f:
    ...
    result_file = "/root/code/thesis/codeFolder/LatestDataInUse/results/t2_hr_spir_ImageResnet.txt"
